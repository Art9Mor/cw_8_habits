...
class Habit(models.Model):
    ...
    time = models.TimeField(verbose_name='Время старта привычки', default=timezone.now)
    action = models.CharField(max_length=120, verbose_name='Действие')
    is_pleasant = models.BooleanField(default=False, verbose_name='Приятная привычка')
    pleasant_link = models.ForeignKey('self', on_delete=models.CASCADE, verbose_name='Ссылка на приятную привычку')
